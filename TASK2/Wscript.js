document.addEventListener('DOMContentLoaded', function() {
  const countriesWeather = {
    ...
    USA: { temperature: '10°C', description: 'Sunny', humidity: '70%', windSpeed: '5 m/s' },
    UK: { temperature: '19°C', description: 'Cloudy', humidity: '80%', windSpeed: '6 m/s' },
    India: { temperature: '32°C', description: 'Humid', humidity: '75%', windSpeed: '7 m/s' },
    Australia: { temperature: '31°C', description: 'Hot', humidity: '50%', windSpeed: '8 m/s' },
    France: { temperature: '20°C', description: 'Partly cloudy', humidity: '60%', windSpeed: '4 m/s' },
    Germany: { temperature: '28°C', description: 'Rainy', humidity: '75%', windSpeed: '4 m/s' },
    Japan: { temperature: '23°C', description: 'Clear sky', humidity: '65%', windSpeed: '7 m/s' },
